...
| 3 | [Прогнозирование заказов такси](https://github.com/veter11111/portfolio/tree/main/forecasting_taxi_orders)|Построение модели для предсказания количества заказов такси на следующий час|Python, pandas, sklearn, catboost, statsmodels|
